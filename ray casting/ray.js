...
class Ray {
  ...
  show(walls) {
    ...
    if (collisionPoint) {
      ...
      const screenDistance = (1000 / 2) / Math.tan(FOV / 2)
      const wallHeight = 50000 / dist_
      ctx3D.fillStyle = `rgba(255, 0, 0, ${1 - dist_ / 700})`
      ctx3D.strokeStyle = `black`
      rect(-(this.rayIndex * 1000/60 - 500), 0, 60, wallHeight, "red")
